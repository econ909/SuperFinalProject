...
public class Card  {
    ...
    private static final String[] RANKS = { "0", "Ace", "2", "3", "4", "5", "6",
    ...
    public void setInPlay(boolean usedCard)  {
       this.inPlay = usedCard; 
    }
    /**
    ...
    public int compareTo(Card that) {
        ...
        // compare the ranks
        int rank1 = (this.rank + 10) % 13;
        int rank2 = (that.rank + 10) % 13;
